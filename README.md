# R code for paper manuscript: Impacts of dynamic aerosol and pathogen concentrations on risks of Legionella pneumophila for Public Showers in Switzerland Based on a Quantitative Microbial Risk Assessment Framework



##### The submitted codes contain the following elements：



1. QMRA\_LeCo\_final. R: Codes for the complete QMRA model. The codes can be used to generate Figure 2, Figure 3, Figure 4, Figure 5, Figure S1, Figure S2, Figure S4, Figure S5, Figure S6, Figure S7, Figure S9 and Figure S10 in the paper manuscript.
2. Fit\_distribution\_legionella\_LeCo\_final. R: Codes for generating temporal distributions of L. pneumophila concentrations in first draw sample concentrations at both cold and hot water conditions (Figure 1). This file should be used in combination with DBDA2E-utilities.
