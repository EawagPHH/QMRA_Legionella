...
### Import the dataset named Water_sample
###
mydataframe <-water_sample
data = dplyr::filter(mydataframe, Temperature=="Cold",Sample_type == "First draw") #Here you can chose first draw sample, flushed sample, cold water and hot water
y = unlist(data[, "Count"])
...
tiff(file = paste("Legio_COLD_CCDF.tiff", sep = ""), width = 3543, height = 3543, 
     units = "px",res = 1000, pointsize = 7)

options(scipen = 0)
point_x = 1
point_y = 1
myTicks<-c(1.0E+1, 1.0E+2, 1.0E+3, 1.0E+4, 1.0E+5, 1.0E+6, 1.0E+7, 1.0E+8, 1.0E+9, 1.0E+10)
